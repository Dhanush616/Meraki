...
export function BeneficiarySummary({ count, hasUnassignedAssets, isLoading }: Props) {
    return (
        <Link
            ...
            className="bg-card rounded-2xl p-6 border border-border hover:bg-muted/50 transition-colors group flex flex-col justify-between"
        >
            {isLoading ? (
                ...
                <>
                    <div>
                        <div className="flex justify-between items-start mb-4">
                            ...
                            {hasUnassignedAssets && (
                                <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-muted text-foreground border border-border">
                    ...
                    <div className="mt-6 flex items-center text-sm text-foreground font-medium group-hover:translate-x-1 transition-transform">
