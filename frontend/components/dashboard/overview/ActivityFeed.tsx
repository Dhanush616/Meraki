    ...
    return (
        <div className="bg-card rounded-2xl p-5 border border-border">
            <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/activity" className="text-xs text-foreground hover:underline font-medium">View all</Link>
            </div>
            {isLoading ? (
                ...
                <p className="text-sm text-muted-foreground py-4 text-center bg-background rounded-lg border border-border">
                    No activity yet.
                </p>
            )}
        </div>
